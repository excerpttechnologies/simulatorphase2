...
import { CHIP_STATES } from './ChipController.js'
...
export class TwoRobotChipProcess {
  ...
  findObjects() {
    this.robot1 = this._findNode('COLRIGHT_CARRIAGE', ['colright', 'carriage'])
    this.robot1Pickup =
      ...
      (this.bonder && this.bonder.robots && this.bonder.robots.colright
        ...
        : null)
    this.robot1Vertical = this._resolveLiftNode(
      [
    ...
    this.robot2 = this._findNode('SKING_MOUNT_BRACKET_VAXIS', ['sking', 'mount', 'bracket', 'vaxis'])
    this.robot2Tip =
  ...
  _computeReach() {
    ...
    this.robot2Reach = {
      ...
      Y: this._calibrateAxis(this.robot2, 'y', this.robot2Tip),
  ...
  _setRobot1Tip(targetWorld) {
    if (!this.robot1Reach) return Promise.resolve()
  ...
  _setRobot2Tip(targetWorld) {
    if (!this.robot2Reach) return Promise.resolve()
  ...
  async moveRobot1ToChip(chip) {
    ...
    await this._moveAxis(this.robot1, 'x', this._axisFor(this.robot1Reach.X, target), BONDER_CONFIG.movement.travelDuration)
    await this._moveAxis(this.robot1Vertical, 'y', this._axisFor(this.robot1Reach.Y, approach), BONDER_CONFIG.movement.lowerDuration)
  ...
  async moveRobot1Lift() {
    ...
    await this._moveAxis(this.robot1Vertical, 'y', this._axisFor(this.robot1Reach.Y, approach), BONDER_CONFIG.movement.liftDuration)
  }
  ...
  async moveRobot2Lift() {
    ...
    await this._moveAxis(this.robot2, 'y', this._axisFor(this.robot2Reach.Y, approach), BONDER_CONFIG.movement.liftDuration)
  }
  ...
  async moveRobot2ToFlux() {
    ...
    await this._moveAxis(this.robot2, 'y', this._axisFor(this.robot2Reach.Y, approach), BONDER_CONFIG.movement.travelDuration)
  }
  ...
  async lowerRobot2ToTarget(target) {
    ...
    await this._moveAxis(this.robot2, 'y', this._axisFor(this.robot2Reach.Y, contact), BONDER_CONFIG.movement.lowerDuration)
  }
  ...
  async retractRobot2() {
    ...
    await this._moveAxis(this.robot2, 'y', this._axisFor(this.robot2Reach.Y, target), BONDER_CONFIG.movement.liftDuration)
  }
  ...
  async moveRobot2ToPosition(position) {
    ...
    await this._moveAxis(this.robot2, 'y', this._axisFor(this.robot2Reach.Y, position), BONDER_CONFIG.movement.travelDuration)
  }
  ...
  async resetRobot2() {
    ...
    await this._moveAxis(this.robot2, 'y', this.robot2Reach.Y.rest, BONDER_CONFIG.movement.liftDuration)

...
import { BONDER_STAGE_IDS, BONDER_STAGE_LABELS } from './BonderConfig.js'
import { BONDER_EVENTS } from './BonderEvents.js'

/**
 * BonderStateMachine â€” explicit, deterministic linear recipe with mandatory
...
export class BonderStateMachine {
  ...
  getStatus() {
    return {
      ...
      progress: (this.completed.length / STAGE_ORDER.length) * 100,
    }
  }
